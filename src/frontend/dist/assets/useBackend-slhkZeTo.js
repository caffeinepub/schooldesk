...
import { S as Subscribable, p as pendingThenable, l as resolveEnabled, s as shallowEqualObjects, m as resolveStaleTime, n as noop, o as environmentManager, q as isValidTimeout, t as timeUntilStale, v as timeoutManager, w as focusManager, x as fetchState, y as replaceData, z as notifyManager, A as hashKey, B as getDefaultState, r as reactExports, C as shouldThrowError, D as useQueryClient } from "./index-BBwbkILB.js";
...
const AddUserResult = Variant({
  "ok": UserProfile,
  "err": Text
});
const CreateFeeInput = Record({
  "studentId": StudentId,
  "lateFeeAmount": Nat,
  "dueDate": Timestamp,
  "amount": Nat,
...
const FeeId = Nat;
const FeeStatus = Variant({
  "Late": Null,
  "Paid": Null,
  "Unpaid": Null
});
const FeeRecord = Record({
  "id": FeeId,
  "status": FeeStatus,
  "studentId": StudentId,
  "lateFeeAmount": Nat,
...
const CreateHomeworkInput = Record({
  "title": Text,
  "createdBy": Text,
  "dueDate": Timestamp,
  "description": Text,
...
const HomeworkId = Nat;
const Homework = Record({
  "id": HomeworkId,
  "title": Text,
  "createdAt": Timestamp,
  "createdBy": Text,
...
const CreateNoticeInput = Record({
  "title": Text,
  "content": Text,
  "createdBy": Text,
  "audience": Audience,
...
const CreateTeacherInput = Record({
...
const AttendanceRateSummary = Record({
  "presentCount": Nat,
  "attendanceRate": Nat,
  "lateCount": Nat,
  "totalRecords": Nat,
...
const FeesCollectionSummary = Record({
  "lateAmount": Nat,
  "totalAmount": Nat,
  "pendingAmount": Nat,
  "collectedAmount": Nat
});
const SubmissionStatus = Variant({
  "Submitted": Null,
  "Pending": Null
});
const HomeworkSubmission = Record({
...
const MarkAttendanceInput = Record({
  "status": AttendanceStatus,
  "studentId": StudentId,
  "date": Timestamp,
  "markedBy": Text
});
const UpdateFeeInput = Record({
  "id": FeeId,
  "status": FeeStatus,
  "lateFeeAmount": Nat,
  "dueDate": Timestamp,
...
const UpdateTeacherInput = Record({
  "id": TeacherId,
  "classesAssigned": Vec(Text),
  "subjects": Vec(Text),
  "name": Text,
...
Service({
  "addMark": Func([Text, AddMarkInput], [Mark], []),
  "addUser": Func([Text, AddUserInput], [AddUserResult], []),
  "createFeeRecord": Func([Text, CreateFeeInput], [FeeRecord], []),
  "createHomework": Func([Text, CreateHomeworkInput], [Homework], []),
  "createNotice": Func([Text, CreateNoticeInput], [Notice], []),
  "createStudent": Func([Text, CreateStudentInput], [Student], []),
  "createTeacher": Func([Text, CreateTeacherInput], [Teacher], []),
  "deleteNotice": Func([Text, NoticeId], [Bool], []),
  "deleteStudent": Func([Text, StudentId], [Bool], []),
  "deleteTeacher": Func([Text, TeacherId], [Bool], []),
  "getAttendanceByClass": Func(
    [Text, Text, Timestamp],
    [Vec(AttendanceRecord)],
    ["query"]
  ),
  "getAttendanceByStudent": Func(
    [Text, StudentId],
    [Vec(AttendanceRecord)],
    ["query"]
  ),
  "getAttendanceRateSummary": Func([], [AttendanceRateSummary], ["query"]),
  "getAttendanceSummary": Func(
    [Text, StudentId],
    [AttendanceSummary],
    ["query"]
  ),
  "getEnrollmentByClass": Func(
    [],
    [Vec(EnrollmentByClass)],
    ["query"]
  ),
  "getFeesCollectionSummary": Func([], [FeesCollectionSummary], ["query"]),
  "getMarksByStudent": Func(
    [Text, StudentId],
    [Vec(Mark)],
    ["query"]
  ),
  "getMarksBySubject": Func(
    [Text, Text],
    [Vec(Mark)],
    ["query"]
  ),
  ...
  "getSubmissions": Func(
    [HomeworkId],
    [Vec(HomeworkSubmission)],
    ["query"]
  ),
  "getTeacher": Func([TeacherId], [Opt(Teacher)], ["query"]),
  "getTotalStudents": Func([], [Nat], ["query"]),
  "getTotalTeachers": Func([], [Nat], ["query"]),
  "listAllFees": Func([], [Vec(FeeRecord)], ["query"]),
  "listFeesByStudent": Func([StudentId], [Vec(FeeRecord)], ["query"]),
  "listHomeworkByClass": Func([Text], [Vec(Homework)], ["query"]),
  "listNotices": Func(
    [Opt(Audience), Opt(Text)],
    [Vec(Notice)],
    ["query"]
  ),
  "listStudents": Func([], [Vec(Student)], ["query"]),
  "listTeachers": Func([], [Vec(Teacher)], ["query"]),
  "login": Func([Text, Text], [LoginResult], []),
  "logout": Func([Text], [], []),
  "markAttendance": Func(
    [Text, MarkAttendanceInput],
    [AttendanceRecord],
    []
  ),
  "markFeePaid": Func(
    [Text, FeeId, Timestamp],
    [Opt(FeeRecord)],
    []
  ),
  "markSubmission": Func(
    [Text, HomeworkId, StudentId],
    [HomeworkSubmission],
    []
  ),
  "updateFeeRecord": Func(
    [Text, UpdateFeeInput],
    [Opt(FeeRecord)],
    []
  ),
  "updateMark": Func([Text, UpdateMarkInput], [Opt(Mark)], []),
  "updateStudent": Func(
    [Text, UpdateStudentInput],
    [Opt(Student)],
    []
  ),
  "updateTeacher": Func(
    [Text, UpdateTeacherInput],
    [Opt(Teacher)],
    []
  ),
  "validateSession": Func([Text], [Opt(UserProfile)], ["query"])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const StudentId2 = IDL2.Nat;
  const Timestamp2 = IDL2.Int;
  const AddMarkInput2 = IDL2.Record({
    "studentId": StudentId2,
    "maxScore": IDL2.Nat,
    "subject": IDL2.Text,
    "date": Timestamp2,
    "assessmentName": IDL2.Text,
    "score": IDL2.Nat
  });
  const MarkId2 = IDL2.Nat;
  const Mark2 = IDL2.Record({
    "id": MarkId2,
    "studentId": StudentId2,
    "maxScore": IDL2.Nat,
    "subject": IDL2.Text,
  ...
  const AddUserInput2 = IDL2.Record({
    "username": IDL2.Text,
    "password": IDL2.Text,
    "name": IDL2.Text,
    "roleId": IDL2.Text
  ...
  const AddUserResult2 = IDL2.Variant({ "ok": UserProfile2, "err": IDL2.Text });
  const CreateFeeInput2 = IDL2.Record({
    "studentId": StudentId2,
    "lateFeeAmount": IDL2.Nat,
    "dueDate": Timestamp2,
    "amount": IDL2.Nat,
    "receiptNumber": IDL2.Text
  });
  const FeeId2 = IDL2.Nat;
  const FeeStatus2 = IDL2.Variant({
    "Late": IDL2.Null,
    "Paid": IDL2.Null,
    "Unpaid": IDL2.Null
  });
  const FeeRecord2 = IDL2.Record({
    "id": FeeId2,
    "status": FeeStatus2,
    "studentId": StudentId2,
    "lateFeeAmount": IDL2.Nat,
    "dueDate": Timestamp2,
    "paidDate": IDL2.Opt(Timestamp2),
    "amount": IDL2.Nat,
    "receiptNumber": IDL2.Text
  });
  const CreateHomeworkInput2 = IDL2.Record({
    "title": IDL2.Text,
    "createdBy": IDL2.Text,
    "dueDate": Timestamp2,
  ...
  const HomeworkId2 = IDL2.Nat;
  const Homework2 = IDL2.Record({
    "id": HomeworkId2,
    "title": IDL2.Text,
    "createdAt": Timestamp2,
    "createdBy": IDL2.Text,
  ...
  const CreateNoticeInput2 = IDL2.Record({
    "title": IDL2.Text,
    "content": IDL2.Text,
    "createdBy": IDL2.Text,
    "audience": Audience2,
    "classId": IDL2.Opt(IDL2.Text)
  });
  const NoticeId2 = IDL2.Nat;
  const Notice2 = IDL2.Record({
    "id": NoticeId2,
    "title": IDL2.Text,
    "content": IDL2.Text,
    "createdAt": Timestamp2,
  ...
  const CreateTeacherInput2 = IDL2.Record({
    "classesAssigned": IDL2.Vec(IDL2.Text),
    "subjects": IDL2.Vec(IDL2.Text),
    "name": IDL2.Text,
    "teacherId": IDL2.Text
  });
  ...
  const AttendanceRateSummary2 = IDL2.Record({
    "presentCount": IDL2.Nat,
    "attendanceRate": IDL2.Nat,
    "lateCount": IDL2.Nat,
    "totalRecords": IDL2.Nat,
    "absentCount": IDL2.Nat
  });
  const AttendanceSummary2 = IDL2.Record({
    "studentId": StudentId2,
  ...
  const EnrollmentByClass2 = IDL2.Record({
    "classId": IDL2.Text,
    "studentCount": IDL2.Nat
  });
  const FeesCollectionSummary2 = IDL2.Record({
    "lateAmount": IDL2.Nat,
    "totalAmount": IDL2.Nat,
    "pendingAmount": IDL2.Nat,
    "collectedAmount": IDL2.Nat
  });
  const SubmissionStatus2 = IDL2.Variant({
    "Submitted": IDL2.Null,
    "Pending": IDL2.Null
  });
  const HomeworkSubmission2 = IDL2.Record({
  ...
  const MarkAttendanceInput2 = IDL2.Record({
    "status": AttendanceStatus2,
    "studentId": StudentId2,
    "date": Timestamp2,
    "markedBy": IDL2.Text
  });
  const UpdateFeeInput2 = IDL2.Record({
    "id": FeeId2,
    "status": FeeStatus2,
    "lateFeeAmount": IDL2.Nat,
    "dueDate": Timestamp2,
  ...
  const UpdateMarkInput2 = IDL2.Record({
    "id": MarkId2,
    "maxScore": IDL2.Nat,
    "assessmentName": IDL2.Text,
    "score": IDL2.Nat
  ...
  const UpdateTeacherInput2 = IDL2.Record({
    "id": TeacherId2,
    "classesAssigned": IDL2.Vec(IDL2.Text),
    "subjects": IDL2.Vec(IDL2.Text),
    "name": IDL2.Text,
  ...
  return IDL2.Service({
    "addMark": IDL2.Func([IDL2.Text, AddMarkInput2], [Mark2], []),
    "addUser": IDL2.Func([IDL2.Text, AddUserInput2], [AddUserResult2], []),
    "createFeeRecord": IDL2.Func([IDL2.Text, CreateFeeInput2], [FeeRecord2], []),
    "createHomework": IDL2.Func(
      [IDL2.Text, CreateHomeworkInput2],
      [Homework2],
      []
    ),
    "createNotice": IDL2.Func([IDL2.Text, CreateNoticeInput2], [Notice2], []),
    "createStudent": IDL2.Func([IDL2.Text, CreateStudentInput2], [Student2], []),
    "createTeacher": IDL2.Func([IDL2.Text, CreateTeacherInput2], [Teacher2], []),
    "deleteNotice": IDL2.Func([IDL2.Text, NoticeId2], [IDL2.Bool], []),
    "deleteStudent": IDL2.Func([IDL2.Text, StudentId2], [IDL2.Bool], []),
    "deleteTeacher": IDL2.Func([IDL2.Text, TeacherId2], [IDL2.Bool], []),
    "getAttendanceByClass": IDL2.Func(
      [IDL2.Text, IDL2.Text, Timestamp2],
      [IDL2.Vec(AttendanceRecord2)],
      ["query"]
    ),
    "getAttendanceByStudent": IDL2.Func(
      [IDL2.Text, StudentId2],
      [IDL2.Vec(AttendanceRecord2)],
      ["query"]
    ),
    "getAttendanceRateSummary": IDL2.Func(
      [],
      [AttendanceRateSummary2],
      ["query"]
    ),
    "getAttendanceSummary": IDL2.Func(
      [IDL2.Text, StudentId2],
      [AttendanceSummary2],
      ["query"]
    ),
    "getEnrollmentByClass": IDL2.Func(
      [],
      [IDL2.Vec(EnrollmentByClass2)],
      ["query"]
    ),
    "getFeesCollectionSummary": IDL2.Func(
      [],
      [FeesCollectionSummary2],
      ["query"]
    ),
    "getMarksByStudent": IDL2.Func(
      [IDL2.Text, StudentId2],
      [IDL2.Vec(Mark2)],
      ["query"]
    ),
    "getMarksBySubject": IDL2.Func(
      [IDL2.Text, IDL2.Text],
      [IDL2.Vec(Mark2)],
      ["query"]
    ),
    "getStudent": IDL2.Func([StudentId2], [IDL2.Opt(Student2)], ["query"]),
    "getSubmissions": IDL2.Func(
      [HomeworkId2],
      [IDL2.Vec(HomeworkSubmission2)],
      ["query"]
    ),
    "getTeacher": IDL2.Func([TeacherId2], [IDL2.Opt(Teacher2)], ["query"]),
    "getTotalStudents": IDL2.Func([], [IDL2.Nat], ["query"]),
    "getTotalTeachers": IDL2.Func([], [IDL2.Nat], ["query"]),
    "listAllFees": IDL2.Func([], [IDL2.Vec(FeeRecord2)], ["query"]),
    "listFeesByStudent": IDL2.Func(
      [StudentId2],
      [IDL2.Vec(FeeRecord2)],
      ["query"]
    ),
    "listHomeworkByClass": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(Homework2)],
      ["query"]
    ),
    "listNotices": IDL2.Func(
      [IDL2.Opt(Audience2), IDL2.Opt(IDL2.Text)],
      [IDL2.Vec(Notice2)],
      ["query"]
    ),
    "listStudents": IDL2.Func([], [IDL2.Vec(Student2)], ["query"]),
    "listTeachers": IDL2.Func([], [IDL2.Vec(Teacher2)], ["query"]),
    "login": IDL2.Func([IDL2.Text, IDL2.Text], [LoginResult2], []),
    "logout": IDL2.Func([IDL2.Text], [], []),
    "markAttendance": IDL2.Func(
      [IDL2.Text, MarkAttendanceInput2],
      [AttendanceRecord2],
      []
    ),
    "markFeePaid": IDL2.Func(
      [IDL2.Text, FeeId2, Timestamp2],
      [IDL2.Opt(FeeRecord2)],
      []
    ),
    "markSubmission": IDL2.Func(
      [IDL2.Text, HomeworkId2, StudentId2],
      [HomeworkSubmission2],
      []
    ),
    "updateFeeRecord": IDL2.Func(
      [IDL2.Text, UpdateFeeInput2],
      [IDL2.Opt(FeeRecord2)],
      []
    ),
    "updateMark": IDL2.Func([IDL2.Text, UpdateMarkInput2], [IDL2.Opt(Mark2)], []),
    "updateStudent": IDL2.Func(
      [IDL2.Text, UpdateStudentInput2],
      [IDL2.Opt(Student2)],
      []
    ),
    "updateTeacher": IDL2.Func(
      [IDL2.Text, UpdateTeacherInput2],
      [IDL2.Opt(Teacher2)],
      []
    ),
    "validateSession": IDL2.Func([IDL2.Text], [IDL2.Opt(UserProfile2)], ["query"])
  });
};
...
class Backend {
  ...
  async createFeeRecord(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async createHomework(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async getAttendanceByClass(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async getAttendanceByStudent(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async getAttendanceRateSummary() {
    if (this.processError) {
      try {
  ...
  async getAttendanceSummary(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async getFeesCollectionSummary() {
    if (this.processError) {
      try {
  ...
  async getMarksByStudent(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async getMarksBySubject(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async listHomeworkByClass(arg0) {
    if (this.processError) {
      try {
  ...
  async markAttendance(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async markFeePaid(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async markSubmission(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async updateFeeRecord(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_AddUserResult_n1(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function from_candid_AttendanceRecord_n22(_uploadFile, _downloadFile, value) {
  return from_candid_record_n23(_uploadFile, _downloadFile, value);
}
function from_candid_AttendanceStatus_n24(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n25(_uploadFile, _downloadFile, value);
}
function from_candid_Audience_n18(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n19(_uploadFile, _downloadFile, value);
}
function from_candid_FeeRecord_n7(_uploadFile, _downloadFile, value) {
  return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_FeeStatus_n9(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n10(_uploadFile, _downloadFile, value);
}
function from_candid_HomeworkSubmission_n28(_uploadFile, _downloadFile, value) {
  return from_candid_record_n29(_uploadFile, _downloadFile, value);
}
function from_candid_LoginResult_n37(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n38(_uploadFile, _downloadFile, value);
}
function from_candid_Notice_n16(_uploadFile, _downloadFile, value) {
  return from_candid_record_n17(_uploadFile, _downloadFile, value);
}
function from_candid_Role_n5(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n6(_uploadFile, _downloadFile, value);
}
function from_candid_SubmissionStatus_n30(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n10(_uploadFile, _downloadFile, value) {
  return "Late" in value ? "Late" : "Paid" in value ? "Paid" : "Unpaid" in value ? "Unpaid" : value;
}
function from_candid_variant_n19(_uploadFile, _downloadFile, value) {
  return "All" in value ? "All" : "Teacher" in value ? "Teacher" : "Student" in value ? "Student" : "Admin" in value ? "Admin" : "Class" in value ? "Class" : value;
}
...
function from_candid_variant_n25(_uploadFile, _downloadFile, value) {
  return "Present" in value ? "Present" : "Late" in value ? "Late" : "Absent" in value ? "Absent" : value;
}
function from_candid_variant_n31(_uploadFile, _downloadFile, value) {
  return "Submitted" in value ? "Submitted" : "Pending" in value ? "Pending" : value;
}
...
function from_candid_variant_n6(_uploadFile, _downloadFile, value) {
  return "Teacher" in value ? "Teacher" : "Student" in value ? "Student" : "Admin" in value ? "Admin" : value;
}
function from_candid_vec_n21(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_AttendanceRecord_n22(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n27(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_HomeworkSubmission_n28(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n33(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_FeeRecord_n7(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n36(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Notice_n16(_uploadFile, _downloadFile, x2));
}
function to_candid_AttendanceStatus_n41(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n42(_uploadFile, _downloadFile, value);
}
function to_candid_Audience_n14(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function to_candid_CreateNoticeInput_n12(_uploadFile, _downloadFile, value) {
  return to_candid_record_n13(_uploadFile, _downloadFile, value);
}
function to_candid_FeeStatus_n46(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n47(_uploadFile, _downloadFile, value);
}
function to_candid_MarkAttendanceInput_n39(_uploadFile, _downloadFile, value) {
  return to_candid_record_n40(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateFeeInput_n44(_uploadFile, _downloadFile, value) {
...
function useMyProfile() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return (result == null ? void 0 : result.ok) ?? null;
    },
...
function useFeesByStudent(studentId) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
...
function useAttendanceByStudent(studentId) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
...
function useAttendanceByClass(className) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
...
function useAttendanceSummary(studentId) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
...
function useHomeworkByClass(className) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
...
function useSubmissions(homeworkId) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
...
function useMarksByStudent(studentId) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        feesCollected: (fees == null ? void 0 : fees.collectedAmount) ? Number(fees.collectedAmount) : 0,
        totalFees: (fees == null ? void 0 : fees.totalAmount) ? Number(fees.totalAmount) : 0,
        attendanceRate: attendanceRate ?? 0,
        enrollmentByClass: (enrollmentByClass == null ? void 0 : enrollmentByClass.map((e) => ({
          className: e.classId,
...
export {
  ...
  useTeachers as f,
  useCreateTeacher as g,
  useUpdateTeacher as h,
  useDeleteTeacher as i,
  useAllFees as j,
  useMarkFeePaid as k,
  useAttendanceByClass as l,
  useMarkAttendance as m,
  useCreateNotice as n,
  useDeleteNotice as o,
  useHomeworkByClass as p,
  useCreateHomework as q,
  useSubmissions as r,
  useMarkSubmission as s,
  useMarksByStudent as t,
  useAnalytics as u,
  useAddMark as v,
  useMyProfile as w,
  useAttendanceSummary as x,
  useFeesByStudent as y,
  useAttendanceByStudent as z
};
